...
public class Game {
	...
	public Game()
	{
		currentLevel = new GameLevelOne(this);
	}

	public void play() {
		Random random = new Random();
		addPoints(random.nextInt(7));
		System.out.println("points="+totalPoints+" level="+currentLevel.getLevelName());
	}
...
//		}
		totalPoints += currentLevel.addPoints(newPoints);

		return totalPoints;
	}


	public void setGameLevel(IGameLevel level) {
